#pragma checksum "C:\Users\selim\Desktop\Csharp\AspNet\NoTech\Areas\Admin\Views\Counter\List.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "745c80a5a779be8ec5f29c796a8863ec4edab9d2"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"745c80a5a779be8ec5f29c796a8863ec4edab9d2", @"/Areas/Admin/Views/Counter/List.cshtml")]
    ...
    <div class=""modal-dialog"">
        <div class=""modal-content"">
            ...
            <div class=""modal-body"">
                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "745c80a5a779be8ec5f29c796a8863ec4edab9d28945", async() => {
                WriteLiteral(@"
                    <div class=""mb-3"">
        ...
        $(document).ready(() => {
            $(document).on('click', '#btnCreate', (e) => {
                $.ajax({
                    ...
                    type: 'POST',
                    data: { odometer: $('#odometerCreate').val() },
                    data: { title: $('#titleCreate').val() },         
                    data: { icon: $('#iconCreate').val() },
                    data: { text: $('#textCreate').val() },
                    success: (Response) => {
                        if (Response.hasOwnProperty('status') && Response.status === 200) {
                            location.href = '/Admin/C");
                WriteLiteral(@"ounter/List';
                        }
